...
class Bank:
    ...
    def deposit_money(self):
        self.money_box=Entry(self.frame)
        self.submitButton=Button(self.frame,text="Submit",bg="#50A8B0",fg="white",font=ARIAL)
        self.money_box.place(x=550,y=220,width=300,height=200)
        self.submitButton.place(x=650,y=150,width=100,height=50)
        self.submitButton.bind("<Button-1>",self.deposit_trans)
        
    def deposit_trans(self,flag):
        self.label=Label(self.frame,text="Transaction complete")
        self.label.place(x=550,y=150,width=300,height=50)
